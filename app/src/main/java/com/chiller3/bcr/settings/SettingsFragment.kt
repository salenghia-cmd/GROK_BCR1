...
class SettingsFragment : PreferenceBaseFragment(), Preference.OnPreferenceChangeListener,
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        // === BIND REALTIME BRIDGE PREFS (Pha 1) ===
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences, key: String?) {
        when {
            ...
            // === REALTIME BRIDGE (Pha 1) ===
            key == Preferences.PREF_ENABLE_REALTIME_BRIDGE ||
            key == Preferences.PREF_REALTIME_OUT_URL -> {
                refreshRealtimeBridgeSummary()
            }
        }
    }
